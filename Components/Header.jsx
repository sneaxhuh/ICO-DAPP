  ...
  ul_li_between">
    <div className="header__left ul_li">
      <div className="header__logo">
        <a href="/">
        <img src="assets/img/logo/logo.svg" alt="nhi" srcset=""/>
        </a>
      </div>
    </div>
    <div className="main-menu__wrap ul_li 
    navbar navbar-expand-xl">
      <nav className="maoin-menu collapse
      navbar-collapse">
        <ul>
          <li >
            <a className="active 
          has-mega-menu" href="/">About</a>
          </li>
          <li >
          ...
          <li >
            <a className="scrollspy-btn" style={{cursor:"pointer",

            }}
            onCLick={()=> ownerModel ? setOwnerModel(false):
              setOwnerModel(true)
            }
          >Tools</a>
          </li>

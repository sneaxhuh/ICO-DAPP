    ...
    <section className="token-info pos-rel pt-200 pb-150">
      <div className="container">
        <div className="row">
          <div className="col-xl-8 offset-xl-4">
            <div className="token-info___title sec-title mb-95 text-center text-xl-start">
        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="token-info__img">
              <img src="assets/img/token/t_info_img.png" alt="Token Info" />
            </div>
          </div>
          ...
          <div className="col-lg-8">
            <div className="token-info--info-wrap ul_li">
              <ul className="token-info__list token-info--start">
                ...
                <li>
                  <h4>Sold Token</h4>
                  <span>{Number(detail?.soldTokens).toLocaleString()} {detail?.symbol}</span>
                </li>
                <li>
              ...
              <ul className="token-info__list token-info--end">
                <li>
                  ...
                  <span>{(Number(detail?.supply) * Number(detail?.tokenPrice)).toLocaleString()}{currency}</span>
                </li>
                <li>
                  <h4>Fund Raised</h4>
                  <span>{(Number(detail?.soldTokens) * Number(detail?.tokenPrice)).toLocaleString()}{currency}</span>
                </li>
                <li>
      ...
      <div className="token-info__shape">
        <div className="shape shape--1">
          <img src="assets/img/shape/ti_shape2.png" alt="Shape" />
        </div>
      </div>
    </section>
  );
